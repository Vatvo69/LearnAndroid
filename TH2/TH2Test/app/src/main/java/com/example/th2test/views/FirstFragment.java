...
import com.example.th2test.adapters.RecyclerViewAdapter;
...
public class FirstFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        List<KhoaHoc> khoaHocList = sqLiteHelper.getAll();


        recyclerViewAdapter = new RecyclerViewAdapter(khoaHocList);
